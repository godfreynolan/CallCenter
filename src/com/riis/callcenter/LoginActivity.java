...
public class LoginActivity extends Activity {
	private BroadsoftRequestRunner requestRunner;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		((TextView)findViewById(R.id.title)).setText("Call Queue Manager");
	...
	private void loginToBroadsoftAndLoadQueuesList() {
		...
		requestRunner.runRequest(BroadsoftRequest.QUEUES_REQUEST, queuesResponseListener);
	}
	...
	private BroadsoftResponseListener queuesResponseListener = new BroadsoftResponseListener() {
		@Override
